...
void PyramidModel::createVAO(Model::ModelType type, const char * const pModelFileName, const char * const objectName)
{
	shutUp(type);
	shutUp(pModelFileName);
	shutUp(objectName);
}
void PyramidModel::createVAO(Model::ModelType type, const char * const pModelFileName, int textureNumber)
{
...
PyramidModel::PyramidModel(const char * const modelFileName)
	: Model()
{
	this->createVAO(Model::ModelType::AnimPyramid, modelFileName, 0);
}
